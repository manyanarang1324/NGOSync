...
const seedData = async () => {
  try {
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/ngosync');
    ...
    console.log('[Seed] Sample Campaigns created...');
    ...
    console.log('[Seed] Sample Events created...');
    ...
    console.log('[Seed] Sample Donations created...');
